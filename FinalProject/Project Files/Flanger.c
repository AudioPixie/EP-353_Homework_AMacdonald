...
#define kInputFileName "Out1.wav"
#define kOutputFileName "Out2.wav"
#define kDepth 0.002 // Second
#define kOffset 0.005 // Second (Needs to be bigger than or equal to kDepth to avoid negative numbers)
#define kRate 0.8 //Hz
